    ...
    return (
      ...
      >
        <div className="space-y-3 w-full">
          {/* Income Comparison */}
          <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-navy-700/50 rounded-lg">
            <div>
            ...
            >
              ...
              <span className="text-sm">{Math.abs(insight.deltas.incomeDelta).toFixed(1)}%</span>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-navy-700/50 rounded-lg">
            ...
            >
              ...
              <span className="text-sm">{Math.abs(insight.deltas.expensesDelta).toFixed(1)}%</span>
            </div>
          </div>
        </div>
      </InsightCard>
